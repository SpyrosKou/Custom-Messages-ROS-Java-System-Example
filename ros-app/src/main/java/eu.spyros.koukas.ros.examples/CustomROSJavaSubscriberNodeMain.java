 ...
 */
public final class CustomROSJavaSubscriberNodeMain extends AbstractNodeMain {
     ...
     */
    public CustomROSJavaSubscriberNodeMain(final java.lang.String rosTopicName, final java.lang.String rosNodeName) {
    ...
    public final void onStart(final ConnectedNode connectedNode) {
        ...
        //create a subscriber, for the rosTopicName, that is of type custom_msgs.RosCustomMessage._TYPE.
        ...
        final Subscriber<custom_msgs.RosCustomMessage> subscriber = connectedNode.newSubscriber(this.rosTopicName, custom_msgs.RosCustomMessage._TYPE);
        ...
        subscriber.addMessageListener(message -> log.info("Subscriber - Received: [" + CustomROSJavaPublisherNodeMain.customMessageToString(message) + "]"));
    }
}