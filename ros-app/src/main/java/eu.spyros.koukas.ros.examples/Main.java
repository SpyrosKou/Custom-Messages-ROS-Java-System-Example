...
public final class Main {
    ...
    public static void main(final String[] args) {
        //Services
        final String serverName = "/spyros/test/server_custom/";
        final String clientName = "/spyros/test/client_custom/";
        final String serviceName = "/spyros/test/service/sum_custom";

        //Topics
        final String publisherName = "/spyros/test/publisher_custom/";
        final String subscriberName = "/spyros/test/subscriber_custom/";
        final String topicName = "/spyros/test/topic_custom/";
...
//                Note that all the nodes below run in parallel
                    ...
                    final CustomROSJavaServerNodeMain serviceServerNodeMain = new CustomROSJavaServerNodeMain(serviceName, serverName);
                    ...
                    final CustomROSJavaClientNodeMain serviceClientNodeMain = new CustomROSJavaClientNodeMain(serviceName, clientName);
                    ...
                    final CustomROSJavaPublisherNodeMain topicPublisherNodeMain = new CustomROSJavaPublisherNodeMain(topicName, publisherName);
                    ...
                    final CustomROSJavaSubscriberNodeMain topicSubscriberNodeMain = new CustomROSJavaSubscriberNodeMain(topicName, subscriberName);
